...
#define DSOS_ESEMAPHORECREATE -14
#define DSOS_ESEMAPHOREOPEN -15
#define DSOS_ESEMAPHORENOEXCL -16
#define DSOS_ESEMAPHOREWAIT -17
#define DSOS_ESEMAPHOREPOST -18
#define DSOS_ESEMAPHORECLOSE -19;
